...
export default function DomaineMagique({ title, points, niveau }) {
    const pointsRequis = niveau < 10 ? indexmaitrises[0].indexDomainesMagiques[`niveau${niveau + 1}`].pointsRequis : 0;
